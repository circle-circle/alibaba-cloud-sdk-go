...
type DescribeAccessGroupsResponse struct {
	*responses.BaseResponse
	...
	AccessGroups DescribeAccessGroupsAccessGroups `json:"AccessGroups" xml:"AccessGroups"`
}

type DescribeAccessGroupsAccessGroups struct {
	AccessGroup []DescribeAccessGroupsAccessGroup `json:"AccessGroup" xml:"AccessGroup"`
}
