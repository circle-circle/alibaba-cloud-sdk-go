...
type DescribeTieringJobsResponse struct {
	*responses.BaseResponse
	...
	TieringJobs DescribeTieringJobsTieringJobs `json:"TieringJobs" xml:"TieringJobs"`
}

type DescribeTieringJobsTieringJobs struct {
	TieringJob []DescribeTieringJobsTieringJob `json:"TieringJob" xml:"TieringJob"`
}

type DescribeTieringJobsTieringJob struct {
