...
type DescribeMountTargetsResponse struct {
	*responses.BaseResponse
	...
	MountTargets DescribeMountTargetsMountTargets `json:"MountTargets" xml:"MountTargets"`
}

type DescribeMountTargetsMountTargets struct {
	MountTarget []DescribeMountTargetsMountTarget `json:"MountTarget" xml:"MountTarget"`
}
