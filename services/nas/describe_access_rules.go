...
type DescribeAccessRulesResponse struct {
	*responses.BaseResponse
	...
	AccessRules DescribeAccessRulesAccessRules `json:"AccessRules" xml:"AccessRules"`
}

type DescribeAccessRulesAccessRules struct {
	AccessRule []DescribeAccessRulesAccessRule `json:"AccessRule" xml:"AccessRule"`
}
