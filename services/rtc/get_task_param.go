...
type GetTaskParamResponse struct {
	*responses.BaseResponse
	...
	UserPanes   GetTaskParamUserPanes0 `json:"UserPanes" xml:"UserPanes"`
}

type GetTaskParamUserPanes0 struct {
	UserPanes []GetTaskParamUserPanes1 `json:"UserPanes" xml:"UserPanes"`
}

type GetTaskParamUserPanes1 struct {
