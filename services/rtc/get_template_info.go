...
type GetTemplateInfoResponse struct {
	*responses.BaseResponse
	...
	UserPanes   GetTemplateInfoUserPanes0 `json:"UserPanes" xml:"UserPanes"`
}

type GetTemplateInfoUserPanes0 struct {
	UserPanes []GetTemplateInfoUserPanes1 `json:"UserPanes" xml:"UserPanes"`
}

type GetTemplateInfoUserPanes1 struct {
